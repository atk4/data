# -*- coding: utf-8 -*-
#
# DSQL documentation build configuration file, created by
...
man_pages = [
    ('index', 'dsql', u'DSQL Documentation',
     [u'Agile Toolkit'], 1)
]
...
texinfo_documents = [
  ('index', 'DSQL', u'DSQL Documentation',
   u'Agile Toolkit', 'DSQL', 'One line description of project.',
   'Miscellaneous'),
]
