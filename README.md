...
Quick-Links: [Documentation](https://agile-data.readthedocs.io). [Namespaces](https://www.agiletoolkit.org/dox/namespaces.html). [Example](https://github.com/atk4/data-primer). [ATK UI](https://github.com/atk4/ui). [Forum](https://forum.agiletoolkit.org/). [Chat](https://gitter.im/atk4/atk4). [Commercial support](https://www.agiletoolkit.org/contact). [Udemy Course](https://www.udemy.com/web-apps-with-php-and-atk/).
...
- [Out of the box UI](https://github.com/atk4/ui). Who wants to build Admin systems today? Tens of professional components: [Crud](https://ui.agiletoolkit.org/demos/crud.php), [Grid](https://ui.agiletoolkit.org/demos/grid.php), [Form](https://ui.agiletoolkit.org/demos/form3.php) as well as add-ons like [Charts](https://github.com/atk4/chart) can be added to your PHP app with 3-lines of code.
...
Watch [Quick Start](https://agile-data.readthedocs.io/en/develop/quickstart.html) or [Screencasts](https://www.youtube.com/watch?v=o16xwkFfnuA&t=182s&index=1&list=PLUUKFD-IBZWaaN_CnQuSP0iwWeHJxPXKS). There is also our [Official Udemy Course](https://forum.agiletoolkit.org/t/udemy-com-atk-course-early-access-limited-time-free/413) and [Full Documentation](https://agile-data.readthedocs.io) ([PDF](https://media.readthedocs.org/pdf/agile-data/develop/agile-data.pdf)).

ATK Data relies on ATK Core and can be greatly complimented by ATK UI:

- [Agile Core](https://agile-core.readthedocs.io/en/develop/) - documents various low-level traits and features such as Containers, Hooks or Exceptions ([PDF](https://media.readthedocs.org/pdf/agile-core/develop/agile-core.pdf))
- [Agile UI](https://agile-ui.readthedocs.io/en/latest/) - documents optional UI components and how to build Web App with them. ([PDF](https://readthedocs.org/projects/agile-ui/downloads/pdf/latest/))
...
- Create a "migrator" script which calculates expression using [action](https://agile-data.readthedocs.io/en/develop/quickstart.html#actions).
...
There is also "Advanced Topics" section in the documentation: https://agile-data.readthedocs.io/en/develop/advanced.html
...
You can, however, [import fields through joins too](https://agile-data.readthedocs.io/en/develop/joins.html)
...
Read more on [working with individual data records](https://agile-data.readthedocs.io/en/develop/persistence.html).
...
- Documentation: https://agile-data.readthedocs.io/en/develop/model.html
...
- Documentation: https://agile-data.readthedocs.io/en/develop/quickstart.html?highlight=action#actions
...
- Documentation: https://agile-data.readthedocs.io/en/develop/expressions.html
...
- Documentation: https://agile-data.readthedocs.io/en/develop/references.html
...
- Documentation: https://agile-data.readthedocs.io/en/develop/conditions.html
...
- Documentation: https://agile-data.readthedocs.io/en/develop/joins.html
...
- Documentation: https://agile-data.readthedocs.io/en/develop/references.html#traversing-dataset
...
- Documentation: https://agile-data.readthedocs.io/en/develop/hooks.html
...
Please consider our other MIT-licensed project - [Agile UI](https://www.agiletoolkit.org/ui) to build something like this:
