...
class EmailFieldTest extends TestCase
{
    public function testEmailFieldBasic(): void
    {
        ...
        $this->expectExceptionMessageIs('Email address does not have domain');
        $entity->set('email', 'xx');
    }
    ...
    public function testEmailValidateDns(): void
    {
        ...
        $this->expectException(ValidationException::class);
        $this->expectExceptionMessageIs('Email address domain does not exist');
    ...
    public function testEmailWithName(): void
    {
        ...
        $this->expectException(ValidationException::class);
        $this->expectExceptionMessageIs('Email address format is invalid');
